...
ActiveRecord::Schema[8.0].define(version: 2026_08_06_000008) do
  ...
  create_table "submissions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["language_slug"], name: "index_submissions_on_language_slug"
    t.index ["stage_slug"], name: "index_submissions_on_stage_slug"
    t.index ["status"], name: "index_submissions_on_status"
    t.index ["user_id"], name: "index_submissions_on_user_id"
  end

  create_table "test_case_results", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["passed"], name: "index_test_case_results_on_passed"
